...
<html class="wide wow-animation" lang="en"> 
  <head>
    ...
    <link rel="stylesheet" href="assets/css-2/bootstrap.css">
    <link rel="stylesheet" href="assets/css-2/style.css">
    <link rel="stylesheet" href="assets/css-2/fonts.css">
		<!--[if lt IE 10]>
  ...
  <body>
        ...
        <div class="swiper-form-wrap">
          ...
          <div class="swiper-container swiper-slider swiper-slider_height-1 swiper-align-left swiper-align-left-custom context-dark bg-gray-darker" data-loop="false" data-autoplay="5500" data-simulate-touch="false" data-slide-effect="fade">
            <div class="swiper-wrapper">
              <div class="swiper-slide" data-slide-bg="assets/images/image-3.jpg">
            ...
            <div class="col-md-6 col-xl-4">
              <article class="event-default-wrap">
                <div class="event-default">
                  <figure class="event-default-image"><img src="assets/images/image-6.jpg" alt="" width="570" height="370"/>
                  </figure>
                  <div class="event-default-caption"><a class="button button-xs button-secondary button-nina" href="#">learn more</a></div>
                </div>
                <div class="event-default-inner">
                  <h5><a class="event-default-title" href="#">Kathmandu Durbar Square</a></h5><span class="heading-5">from $280</span>
                </div>
              </article>
            </div>
            <div class="col-md-6 col-xl-4">
              <article class="event-default-wrap">
                <div class="event-default">
                  <figure class="event-default-image"><img src="assets/images/image-2.jpg" alt="" width="570" height="370"/>
                  </figure>
                  <div class="event-default-caption"><a class="button button-xs button-secondary button-nina" href="#">learn more</a></div>
                </div>
                <div class="event-default-inner">
                  <h5><a class="event-default-title" href="#">Lakeside.pokhara</a></h5><span class="heading-5">from $480</span>
                </div>
              </article>
            </div>
            <div class="col-md-6 col-xl-4">
              <article class="event-default-wrap">
                ...
                <div class="event-default-inner">
                  <h5><a class="event-default-title" href="#">Illam Tea garden</a></h5><span class="heading-5">from $350</span>
                </div>
              </article>
            </div>
            <div class="col-md-6 col-xl-4">
              <article class="event-default-wrap">
                <div class="event-default">
                  <figure class="event-default-image"><img src="assets/images/image-4.jpg" alt="" width="570" height="370"/>
                  </figure>
                  <div class="event-default-caption"><a class="button button-xs button-secondary button-nina" href="#">learn more</a></div>
                </div>
                <div class="event-default-inner">
                  <h5><a class="event-default-title" href="#">Mt.Everest</a></h5><span class="heading-5">from $350</span>
                </div>
              </article>
            </div>
            <div class="col-md-6 col-xl-4">
              <article class="event-default-wrap">
                ...
                <div class="event-default-inner">
                  <h5><a class="event-default-title" href="#">Annapurna Base Camp</a></h5><span class="heading-5">from $520</span>
                </div>
              </article>
            </div>
            <div class="col-md-6 col-xl-4">
              <article class="event-default-wrap">
                ...
                <div class="event-default-inner">
                  <h5><a class="event-default-title" href="#">Palpa</a></h5><span class="heading-5">from $600</span>
                </div>
              </article>
            </div>
          </div>
          ...
          <div class="row row-50 justify-content-sm-center text-left">
            <div class="col-sm-10 col-md-6 col-xl-3">
              <article class="box-minimal box-minimal-border">
                ...
                <p class="big box-minimal-title">Package Booking</p>
                <hr>
                <div class="box-minimal-text text-spacing-sm">At our travel agency, you can book packages to any world destination. We also provide online package booking via our website in just a couple of steps.</div>
              </article>
            </div>
            <div class="col-sm-10 col-md-6 col-xl-3">
              <article class="box-minimal box-minimal-border">
                <div class="box-minimal-icon novi-icon mdi mdi-map"></div>
                <p class="big box-minimal-title">Trekking</p>
                <hr>
                <div class="box-minimal-text text-spacing-sm">Besides regular tours and excursions, we also offer a variety of trekking for different customers looking for awesome experiences.</div>
              </article>
            </div>
            <div class="col-sm-10 col-md-6 col-xl-3">
              <article class="box-minimal box-minimal-border">
            ...
            <div class="col-sm-10 col-md-6 col-xl-3">
              <article class="box-minimal box-minimal-border">
                ...
                <p class="big box-minimal-title">Mountain Climbing</p>
                <hr>
                <div class="box-minimal-text text-spacing-sm">Our agency provides varied tours including mountain climbing for clients who are searching for an exclusive and memorable vacation.</div>
              </article>
            </div>
          </div>
        </div>
          ...
          <div class="row row-50">
            <div class="col-sm-12">
              ...
              <div class="owl-carousel owl-carousel-team owl-carousel-inset" data-items="1" data-md-items="2" data-xl-items="3" data-stage-padding="15" data-loop="true" data-margin="30" data-mouse-drag="false" data-dots="true" data-autoplay="true">
                <article class="post-blog"><a class="post-blog-image" href="#"><img src="assets/images/image-6.jpg" alt="" width="570" height="415"/></a>
                ...
                <article class="post-blog"><a class="post-blog-image" href="#"><img src="assets/images/image-7.jpg" alt="" width="570" height="415"/></a>
                  <div class="post-blog-caption">
                    <div class="post-blog-caption-header">
                      <ul class="post-blog-tags">
                ...
                <article class="post-blog"><a class="post-blog-image" href="#"><img src="assets/images/image-4.jpg" alt="" width="570" height="415"/></a>
                  <div class="post-blog-caption">
                    <div class="post-blog-caption-header">
                      <ul class="post-blog-tags">
        ...
        <div class="container container-bigger">
          ...
          <div class="owl-carousel owl-layout-1" data-items="1" data-dots="true" data-nav="true" data-stage-padding="0" data-loop="true" data-margin="30" data-mouse-drag="false" data-autoplay="true">
            <article class="quote-boxed">
              <div class="quote-boxed-aside"><img class="quote-boxed-image" src="assets/images/person-1.jpg" alt="" width="210" height="210"/>
              </div>
              <div class="quote-boxed-main">
                ...
                <div class="quote-boxed-meta">
                  <p class="quote-boxed-cite">Stacy</p>
                  <p class="quote-boxed-small">Regular Customer</p>
                </div>
              </div>
            </article>
            <!-- <article class="quote-boxed">
              <div class="quote-boxed-aside"><img class="quote-boxed-image" src="assets/images-2/quote-user-2-210x210.jpg" alt="" width="210" height="210"/>
              </div>
              <div class="quote-boxed-main">
                <div class="quote-boxed-text">
            ...
            <article class="quote-boxed">
              <div class="quote-boxed-aside"><img class="quote-boxed-image" src="assets/images-2/quote-user-3-210x210.jpg" alt="" width="210" height="210"/>
              </div>
              <div class="quote-boxed-main">
                <div class="quote-boxed-text">
      ...
      <footer class="section page-footer page-footer-minimal novi-background bg-cover text-center bg-gray-darker">
        <div class="container container-wide">
          <div class="row row-fix justify-content-sm-center align-items-md-center row-30">
            <!-- <div class="col-md-10 col-lg-7 col-xl-4 text-xl-left"><a href="index.html"><img class="inverse-logo" src="assets/images-2/logo-inverse-208x46.png" alt="" width="208" height="46"/></a></div>
            <div class="col-md-10 col-lg-7 col-xl-4"> -->
              <p class="right">&#169;&nbsp;<span class="copyright-year"></span> All Rights Reserved. Design&nbsp;by&nbsp;<a href="https://www.templatemonster.com">TMS</a></p>
            </div>
    ...
    <!-- Javascript-->
    <script src="assets/js-2/core.min.js"></script>
    <script src="assets/js-2/script.js"></script>
    <!-- coded by barber-->
  </body>
</html>